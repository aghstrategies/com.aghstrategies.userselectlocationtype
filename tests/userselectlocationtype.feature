...
THEN The users address will be saved as "location type"="Main", City="Nashville"
...
THEN The users email address will be saved as example@ex.com "location type"="Main"
